    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by Sivaramakrishnan B</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .manph1{
            background-image: url(/static/images/hardk.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .manph2{
            background-image: url(/static/images/jadu.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/images/kl.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/koli.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/chal.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <ul>
                        <li><b>Landline:</b> 044-45577575</li>
                        <li><b>Mobile</b>: 6381882176</li>
                        <li><b>Facebook</b>: fb/cartoonpro</li>
                        <li><b>Email Id:</b>siva@fancyuniv.com</li>
                    </ul>
